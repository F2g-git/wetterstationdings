...
const int startPositionInSteps = 0; // Startposition des Zeigers in steps (if not zero, please adjust)
const int endPositionInSteps = 2048; // adjust according to startPosition. 
